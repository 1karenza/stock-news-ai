...
def fallback_detailed_summary(item, article_text=""):
    bullets = summary_sentences({**item, "article_text": article_text}, detail=True) or ["Nguồn hiện chỉ có tiêu đề hoặc mô tả quá ngắn, chưa đủ nội dung để tóm tắt chi tiết."]
    quick = (
